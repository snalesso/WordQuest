...
public class GetCategoryHeaders
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await this._matchCreationService.SeedCategories(cancellationToken);
        var categories = await this._matchCreationService.GetRandomCategories(alphabetId, 8, cancellationToken);

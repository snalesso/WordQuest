...
//        //builder.Services.AddSingleton<IReadWriteUnitOfWorkFactory<IGameUnitOfWork>>(provider => EFCoreMatchCreationService());
...
//    //    builder.Services.AddSingleton<IReadOnlyUnitOfWorkFactory<IReadOnlyGameDbConnectionContext>, InMemoryGameUnitOfWorkFactory>();
//    //}
...
//    {
//        //builder.Services.AddSingleton<EfCoreReadOnlyGameDbConnectionContext>();
...
//        //builder.Services.AddSingleton<IReadOnlyUnitOfWorkFactory<IReadOnlyGameDbConnectionContext>, ReadOnlyGameUnitOfWorkFactory>();
//    }

...
{
    public AlphabetInfo(/*int id,*/ string? nativeName, ILanguageOption language, IEnumerable<ICharInfo> charInfos)
    {
        // TODO: checks
        //this.Id = id;
    ...
    public IReadOnlyList<ICharInfo> CharInfos { get; } // TODO: replace with map of metadata
}

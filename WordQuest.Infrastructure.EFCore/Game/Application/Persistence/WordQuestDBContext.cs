...
using WordQuest.Infrastructure.EFCore.Persistence.MSSQLS.Models;

namespace WordQuest.Infrastructure.EFCore.Persistence.MSSQLS
{
    internal partial class WordQuestDBContext : DbContext
    {
